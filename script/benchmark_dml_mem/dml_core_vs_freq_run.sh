...
export MYMPIRUN_ATTACH=`which attach`' -c p'
...
/home/bench/runtime/tools/bin/check_turbo >& freq_initial.out
...
mympirun -a -np $np $myEXE --steplog 0 --unroll 8 --type read --cacheline 64  --mode special --prefix freq_$f --matrixsize 2000 --stride 64 --output out_DATA &>> $d/myoutput
