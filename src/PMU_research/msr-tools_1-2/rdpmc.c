...
int main (){
    ...
    printf ("PMC 1  - Uops Dispatched on Port 0         : %lu \n", rdpmc(0));
    printf ("PMC 1  - Uops Dispatched on Port 1         : %lu \n", rdpmc(1));
    printf ("PMC 1  - Uops Dispatched on Port 2         : %lu \n", rdpmc(2));
    printf ("PMC 1  - Uops Dispatched on Port 3         : %lu \n", rdpmc(3));
//
//    char command[50];
